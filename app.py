...
#OLD DB app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://neondb_owner:npg_EDkMvy5q7PcV@ep-delicate-art-a2qhgk2m-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div id="vehicle_dropdown" style="display:none;">
            ...
            <select id="vehicle_select" name="vehicle_select">
                ...
                <option {% if vehicle_select == 'LS95WRGP-New Holland Wessel' %}selected{% endif %}>LS95WRGP-New Holland Wessel</option>
                <option {% if vehicle_select == 'Klein Bowser' %}selected{% endif %}>Klein Bowser</option>
            </select>
        </div>
